...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch("https://telegra.ph/file/78b23bab8cbaa995a0626.jpg")).buffer(), text.trim(), 'beri jeda bot 6 detik', 'Pemilik Bot', `#445`, 'Menu', `${_p} menu`, m)
  } catch (e) {
